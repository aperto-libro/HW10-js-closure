...
----Ответ на твой вопрос. Переменная через let, которая внутри, будет локальной, потому что 
блок кода с циклом создает блочную область видимости. Это работает для переменных через let 
и const, но не для var.
*/
